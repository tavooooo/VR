...
const I18N = {
  en: {
    ...
    realBgHint: "Opens your camera — place the character in the real scene",
    storyLabel: "Story",
  ...
  es: {
    ...
    realBgHint: "Abre tu cámara — coloca al personaje en la escena real",
    storyLabel: "Historia",
